...
$.each(myOptions, function(val, text) {
    $("#depth").append(
        $('<option></option>').val(val).html(text)
             ...
             You have selected crawl web site as <b> <%=pageContext.getServletContext().getInitParameter("web-crawl-site")%> </b> and crawl index directory as <b><%=pageContext.getServletContext().getInitParameter("web-crawl-dir")%></b>
             <br>
             <br>
             <a id="crawl" href="#" > Want to Index for other site</a>
             <br>
             <br>
             ...
             <div id="crawlSite">
                 <table id="customer">
                     <tr><td> Enter Web Site to Crawl <input type="text" name="site" id="site"/></td></tr>
                     <tr><td> Enter Crawl Depth <select name="depth" id="depth"> (Note : More Depth may take more time to index.choose 1)
         
         </select>    </td></tr>
                 </table>
                 <input type="submit" onclick="javascript:document.getElementById('pBar').style.display='block'"  value="Crawl">
